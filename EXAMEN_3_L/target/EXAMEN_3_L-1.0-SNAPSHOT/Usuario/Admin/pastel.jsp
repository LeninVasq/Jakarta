...
<%@page import="Controladores.RecetasJpaController"%>
...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <%= %>
            <h1>Los 10 tipo de cocina mas preferidos</h1>
...
<script>
    ...
    <%
        ...
        RecetasJpaController favoritosController = new RecetasJpaController();
        
        // Obtener los resultados de la consulta para recetas populares
        List<Object[]> resultadosPopulares = favoritosController.findTopRecetas();
    ...
    const config = {
        type: 'pie',  // Cambiar 'bar' a 'pie'
        data: data,   // Los datos permanecen igual
        options: {
            responsive: true,
            plugins: {
                legend: {
                    position: 'top',  // Puedes elegir la posición de la leyenda (top, left, bottom, right)
                },
                tooltip: {
                    callbacks: {
                        label: function(tooltipItem) {
                            return tooltipItem.label + ': ' + tooltipItem.raw;  // Personalizar el tooltip si es necesario
                        }
                    }
                }
            }
