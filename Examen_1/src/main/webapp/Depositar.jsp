<%-- 
    Document   : Depositar
    Created on : 24 ago 2024, 7:44:42 p.m.
    Author     : Vasquez
--%>
            ...
            <div class="container mt-5">
                <div class="row">
                  <div class="col-12">
                    ...
                    <form method="post" class="mt-3" action="Procesardeposito.jsp">
                    ...
                    <input type="text" id="cuenta" name="Cuenta" display="none"   value="<%= Cuenta %>" class="form-control" placeholder="Ingrese el número de cuenta" >
                          ...
                          <div class="col-md-6 mt-3" >
                            ...
                            <input type="number" id="apellido" name="Monto" class="form-control" placeholder="Ingrese el monto a depositar" required="">
                          </div>
